...
public class setWallsInvisible : MonoBehaviour {

    GameObject Wall1, Wall2, Wall3, Wall4, Wall5, Wall6, Wall7, Wall8, Wall9, Wall10, Wall11, Wall12;
	...
	void Start () {
        ...
        Wall12 = transform.Find("Wall12").gameObject;
        Wall12.renderer.enabled = false;
	}
}
